...
VLOG_WARN("DARRELL propagate_tunnel_data_to_flow__: Before: flow->nw_frag %d", dst_flow->nw_frag);
VLOG_WARN("DARRELL propagate_tunnel_data_to_flow__: Before: flow->in_port.ofp_port %u", dst_flow->in_port.ofp_port);
VLOG_WARN("DARRELL propagate_tunnel_data_to_flow__: Before: flow->nw_src"IP_FMT, IP_ARGS(dst_flow->nw_src));
VLOG_WARN("DARRELL propagate_tunnel_data_to_flow__: Before: flow->nw_dst"IP_FMT, IP_ARGS(dst_flow->nw_dst));
VLOG_WARN("DARRELL propagate_tunnel_data_to_flow__: Before: flow->nw_proto %d", dst_flow->nw_proto);
...
VLOG_WARN("DARRELL propagate_tunnel_data_to_flow__: After: flow->nw_frag %d", dst_flow->nw_frag);
VLOG_WARN("DARRELL propagate_tunnel_data_to_flow__: After: flow->in_port.ofp_port %u", dst_flow->in_port.ofp_port);
VLOG_WARN("DARRELL propagate_tunnel_data_to_flow__: After: flow->nw_src"IP_FMT, IP_ARGS(dst_flow->nw_src));
VLOG_WARN("DARRELL propagate_tunnel_data_to_flow__: After: flow->nw_dst"IP_FMT, IP_ARGS(dst_flow->nw_dst));
VLOG_WARN("DARRELL propagate_tunnel_data_to_flow__: After: flow->nw_proto %d", dst_flow->nw_proto);
...
VLOG_WARN("DARRELL xlate_actions: not frozen_state with recirc_id");
        xlate_report_error(&ctx,
...
VLOG_WARN("DARRELL xlate_actions: ctx.base_flow.in_port.ofp_port %u", ctx.base_flow.in_port.ofp_port);
...
VLOG_WARN("DARRELL xlate_actions: tnl_process_ecn(flow)");
